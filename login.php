...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    <title> MDM || Users Login Page </title>
  </head>
  <body>
               ...
               <form class="text-center" method="post" action="login.php">
                 ...
                 ?>
                    <div class="form-group">
                        <input type="email" class="form-control form-input" id="exampleInputEmail1" placeholder="Enter Email Address" name="email" id="email">
                    </div>
