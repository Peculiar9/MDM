        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto pl-5 mr-4">
            ...
            <!-- <li class="nav-item ml-3">
              <a class="nav-link" href="index.php?id=cart" tabindex="-1" aria-disabled="true" data-toggle="modal" data-target="#cart_container" name="submit">Cart <i class="fa fa-shopping-cart"></i></a>
            </li> <sub>0</sub>
          </ul> -->
